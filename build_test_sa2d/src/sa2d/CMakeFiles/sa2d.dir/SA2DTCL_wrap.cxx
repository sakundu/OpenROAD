...
#define SWIG_init    Sa2d_Init
#define SWIG_name    "sa2d"
#define SWIG_prefix  "sa2d::"
#define SWIG_namespace "sa2d"
...
#endif
SWIGINTERN int
_wrap_getSA2D(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  sa2d::SA2D *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":sa2d::getSA2D ") == TCL_ERROR) SWIG_fail;
  {
    try {
      result = (sa2d::SA2D *)sa2d::getSA2D(); 
    }
    catch (std::bad_alloc &) {
  ...
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_sa2d__SA2D,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_set_num_workers(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:sa2d::set_num_workers num_workers ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_num_workers" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  {
    try {
      sa2d::set_num_workers(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
SWIGINTERN int
_wrap_set_max_temp(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  float arg1 ;
  float val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:sa2d::set_max_temp max_temp ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_float SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_max_temp" "', argument " "1"" of type '" "float""'");
  } 
  arg1 = static_cast< float >(val1);
  {
    try {
      sa2d::set_max_temp(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
SWIGINTERN int
_wrap_set_min_temp(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  float arg1 ;
  float val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:sa2d::set_min_temp min_temp ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_float SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_min_temp" "', argument " "1"" of type '" "float""'");
  } 
  arg1 = static_cast< float >(val1);
  {
    try {
      sa2d::set_min_temp(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
SWIGINTERN int
_wrap_set_cooling_rate(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  float arg1 ;
  float val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:sa2d::set_cooling_rate cooling_rate ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_float SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_cooling_rate" "', argument " "1"" of type '" "float""'");
  } 
  arg1 = static_cast< float >(val1);
  {
    try {
...
SWIGINTERN int
_wrap_set_max_iter(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:sa2d::set_max_iter max_iter ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_max_iter" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  {
    try {
      sa2d::set_max_iter(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
SWIGINTERN int
_wrap_set_move_budget(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:sa2d::set_move_budget move_budget ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_move_budget" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  {
    try {
      sa2d::set_move_budget(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
SWIGINTERN int
_wrap_set_gwtw_interval(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:sa2d::set_gwtw_interval interval ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_gwtw_interval" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  {
    try {
      sa2d::set_gwtw_interval(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
SWIGINTERN int
_wrap_set_elite_ratio(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  float arg1 ;
  float val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:sa2d::set_elite_ratio ratio ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_float SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_elite_ratio" "', argument " "1"" of type '" "float""'");
  } 
  arg1 = static_cast< float >(val1);
  {
    try {
      sa2d::set_elite_ratio(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
_wrap_set_seed(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:sa2d::set_seed seed ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
...
SWIGINTERN int
_wrap_set_max_displacement(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:sa2d::set_max_displacement max_displacement_x max_displacement_y ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_max_displacement" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "set_max_displacement" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    try {
      sa2d::set_max_displacement(arg1,arg2); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "getSA2D", (swig_wrapper_func) _wrap_getSA2D, NULL},
    { SWIG_prefix "set_num_workers", (swig_wrapper_func) _wrap_set_num_workers, NULL},
...
SWIGEXPORT int Sa2d_SafeInit(Tcl_Interp *interp) {
