...
#endif
SWIGINTERN int
_wrap_preview_dft(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  bool arg1 ;
  bool val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:dft::preview_dft verbose ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_bool SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "preview_dft" "', argument " "1"" of type '" "bool""'");
  } 
...
SWIGINTERN int
_wrap_insert_dft(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":dft::insert_dft ") == TCL_ERROR) SWIG_fail;
  {
    try {
      insert_dft(); 
    }
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "preview_dft", (swig_wrapper_func) _wrap_preview_dft, NULL},
    { SWIG_prefix "scan_replace", (swig_wrapper_func) _wrap_scan_replace, NULL},
    { SWIG_prefix "insert_dft", (swig_wrapper_func) _wrap_insert_dft, NULL},
